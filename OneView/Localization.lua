...
elseif GetLocale() == "ruRU" then 
    ONEVIEW_LOCALE_CONFIGMENU = "Меню настроек" 
    ONEVIEW_LOCALE_CHARSELECT = "Выбор персонажа"
	BINDING_NAME_ONEVIEW_BINDING = "Открыть/Закрыть окно банка"
else 
    ONEVIEW_LOCALE_CONFIGMENU = "Config Menu" 
    ONEVIEW_LOCALE_CHARSELECT = "Char Select"
	BINDING_NAME_ONEVIEW_BINDING = "Toggle Frame"
end

AL:new("OneView"):RegisterTranslations("enUS", function() return {
...
AL:new("OneView"):RegisterTranslations("ruRU", function() return {
	["Show the OneView Frame"]	= "Показать окно банка",
	...
	["Backpack"] = "Рюкзак",
	["Turns display of your backpack on and off."] = "Вкл./Выкл. отображение содержимого рюкзака.",
	...
	["Turns display of your fourth bag on and off."] = "Вкл./Выкл. отображение содержимого четвертой сумки.",
	["First Bank Bag"] = "Первая сумка банка",
	["Turns display of your first bag on and off."] = "Вкл./Выкл. отображение содержимого первой сумки банка.",
	["Second Bank Bag"] = "Вторая сумка банка",
	["Turns display of your second bag on and off."] = "Вкл./Выкл. отображение содержимого второй сумки банка.",
	["Third Bank Bag"] = "Третья сумка банка",
	["Turns display of your third bag on and off."] = "Вкл./Выкл. отображение содержимого третьей сумки банка.",
	["Fourth Bank Bag"] = "Четвёртая сумка банка",
	["Turns display of your fourth bag on and off."] = "Вкл./Выкл. отображение содержимого четвертой сумки банка.",
	["Fifth Bank Bag"] = "Пятая сумка банка",
	["Turns display of your fifth bag on and off."] = "Вкл./Выкл. отображение содержимого пятой сумки банка.",
	["Sixth Bank Bag"] = "Шестая сумка банка",
	["Turns display of your sixth bag on and off."] = "Вкл./Выкл. отображение содержимого шестой сумки банка.",
	["Show Button"] = "Показать кнопку",
	["Toggles if the OneView quick button is shown."] = "Вкл./Выкл. отображение кнопки OneView.",
	
	["Remember"] = "Запомнить",
	["Remember Selection"] = "Запомнить выбор",
	["Toggles wether to remember which was the last character you selected."] = "Вкл./Выкл. запоминание, какой выбор был сделан последним персонажем.",
	["%s's Bank Bags"] = "%s: Сумки банка",
	["%s's Bags"] = "%s: Сумки",
	["%s/%s Slots"] = "%s/%s ячейки",
	["%s/%s Ammo"] = "%s/%s боеприпасы",
	["%s/%s Soul Shards"] = "%s/%s камни душ",
	["%s/%s Profession Slots"] = "%s/%s проф. ячейки",
	["Characters on "] = "Персонажи на ",
}end)

AL:new("OneView"):RegisterTranslations("frFR", function() return {
...
AL:new("OneView"):RegisterTranslations("zhCN", function() return {
...
AL:new("OneView"):RegisterTranslations("deDE", function() return {
...
AL:new("OneView"):RegisterTranslations("koKR", function() return {
